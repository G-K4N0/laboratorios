...
const handleKeyPress = (e) => {
  ...
  return (
    <Navbar className="nav_container" variant="dark" expand="sm">
      <Container fluid>
        <Navbar.Brand >
          <img src={pantera} width="50" className="d-inline-block align-left" alt="" />
          Centro de Cómputo
        </Navbar.Brand>
        {horarios.length > 0 ? (
          ...
          <div className="input-button-container">
            ...
            <Button variant="success" onClick={handleButtonClick} className="ml-2" disabled={!numeroLaboratorio}>
                Ingresar
              </Button>
          </div>
        )}
